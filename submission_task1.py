...
SUBMISSION_INFO = {
    ...
    "Participant_Names": "Sujata Gaihre, Amir Thapa, Prasuna Pokhrel and Laxmi Tiwari",
    "Affiliations": "Research and Development",
    "Contact_emails": ["sujatag391@gmail.com", "amirthapa2019@gmail.com", "prasunapokharel5@gmail.com", "tiwarilaxuu@gmail.com"],
    # But, the first email only will be used for correspondance
    "Team_Name": "Sagarmatha Rangers",
    "Country": "Nepal",
    "Notes_to_organizers": '''
        finetuned model with hyperparameters, data augumentation in image part 
        '''
}
...
model_hf = AutoModelForCausalLM.from_pretrained(
    "laxuu/Florence-2-vqa_final", trust_remote_code=True).to(device)
